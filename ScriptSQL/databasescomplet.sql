-- =====================================================================
-- Script de creation + peuplement de la base ci4_ecole
-- Corrige : le fichier original plantait a cause d'un probleme
-- d'ENCODAGE (accents colles depuis la console Windows, codepage 850),
-- pas d'une erreur SQL. Toutes les tables/insertions etaient valides ;
-- une seule ligne fautive (caracteres accentues mal encodes) a fait
-- avorter la transaction, ce qui a fait echouer TOUT le reste du script.
--
-- Ce fichier est encode en UTF-8 (sans accents dans les chaines pour
-- rester 100% sur, mais vous pouvez remettre les accents si vous
-- l'executez avec l'encodage client force en UTF8, voir instructions
-- d'execution en bas de fichier).
-- =====================================================================
...
WITH fallback_etab AS (
    ...
    SELECT 'Lycee Technique de Tananarive', 'Antananarivo, Madagascar', '+261 34 00 000 01', 'contact@lycee-tana.mg'
...
INSERT INTO profils_professeurs (user_id, matricule, nom, prenom, date_naissance, sexe, telephone, adresse, specialite, type_contrat, date_debut_contrat) VALUES
    (1, 'PROF001', 'Rakoto', 'Jean', '1980-05-15', 'H', '+261 34 00 001 01', 'Antananarivo', 'Mathematiques', 'permanent', '2015-09-01'),
...
INSERT INTO supports_cours (affectation_id, type_fichier_id, titre, description, fichier_url, type_contenu, date_limite, accepte_retard, cree_par) VALUES
    ...
    (1, 1, 'Devoir maison n1', 'Devoir a rendre pour le 20 janvier', '/uploads/maths/seconde/dm1.pdf', 'devoir_maison', '2026-01-20 23:59:59', TRUE, 1),
    ...
    (4, 1, 'TP n1 - Mesures de masse', 'Compte-rendu de TP a rendre', '/uploads/physique/seconde/tp1_mesures.pdf', 'exercice', '2026-01-25 23:59:59', FALSE, 2),
    (10, 1, 'Lecture analytique n1', 'Analyse du texte "Le Horla"', '/uploads/francais/seconde/lecture_horla.pdf', 'lecon', NULL, FALSE, 4),
...
BEGIN
    ...
    IF v_annee_id IS NULL THEN
        RAISE NOTICE 'Aucune annee scolaire active trouvee.';
        RETURN;
    END IF;
